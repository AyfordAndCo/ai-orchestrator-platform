...
This repository vendors the ECC agent-harness bundle under `.claude/`
(skills, agents, slash commands, coding rules). `.claude/` is generated by
`pnpm ecc:refresh`; do not hand-edit it. The ECC hook runtime is disabled by
default. See [`docs/tooling/ecc.md`](docs/tooling/ecc.md).

ECC guidance is subordinate to this file, `SPEC.md`, and `ROADMAP.md`. Where
they conflict, the repository governance in this file wins.
